def run_deposit():
    ...
    print(f"\n\nYour principle amount is ${principle} in your local currency.")
    print(f"Your interest rate in percentages is {interest}%.")
    print(f"Your time for the fixed deposit is {time_year} years.")
    print(f"The money you will get for interest is ${i_money} in your local currency.")
    print(f"Your total money including all charges is ${p_money} in your local currency.")      
